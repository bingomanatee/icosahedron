...
function point(mongoose) {
    ...
    schema.methods.equalize = require('./Point/equalize');

    schema.methods.post_equalize = require('./Point/post_equalize');
    ...
    schema.methods.get_real_order = require('./Points/get_real_order');
